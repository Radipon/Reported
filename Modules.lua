...
addon.modules = {}
addon.moduleInfo = { -- Modules Default table which is compared to the saved variable module table, and removes/adds values if needed
    Default = {
		["Toggle"] = 'On',
	...
	KOTH = {
		["Toggle"] = 'Off',
		["Description"] = "I got that foul mouthed person banned, I tell you what!  Made by mekkanare",
		["Counter"] = 0
	},
	The_Beatles = {
		["Toggle"] = 'Off',
  		["Description"] = "The beatles croon against cursing.  made by rocsteady",
		["Counter"] = 0
	},
	The_Waterboy = {
		["Toggle"] = 'Off',
  		["Description"] = "ADAM SANDLES PLAYS A RIVITING ROLE IN THIS MODULE.  Made by bobz0r",
		["Counter"] = 0
	},
	John_Wayne = {
		["Toggle"] = 'Off',
	...
	Battlestar_Galactica = {
		["Toggle"] = 'Off',
  		["Description"] = "Only filthy Cylons say such terrible words. Made by Internet Wizard and his friend",
		["Counter"] = 0
	},
	Lady_Gaga = {
		["Toggle"] = 'Off',
  		["Description"] = "The Queen of Pop, not the Queen of Swearing. Made by Internet Wizard's friend",
		["Counter"] = 0
	},
	Twilight = {
		["Toggle"] = 'Off',
  		["Description"] = "Vampires hate cussing. Made by Internet Wizard",
		["Counter"] = 0
	},
	Power_Rangers = {
		["Toggle"] = 'Off',
  		["Description"] = "Gogo power rangers, combine to make Optimus Prime! Made by Internet Wizard's friends and some from sneep",
		["Counter"] = 0
	},
	Pokemon = {
		["Toggle"] = 'Off',
  		["Description"] = "Man child module. Made by Internet Wizard's friends and some from sneep",
		["Counter"] = 0
	},
	Achievements = {
		["Toggle"] = 'Off',
  		["Description"] = "grats buddy! Made by Pleads",
		["Counter"] = 0
	},
	GC = {
		["Toggle"] = 'Off',
		["Description"] = "Ghostcrawler hates you. Made by Sacro",
		["Counter"] = 0
	},
	Dad = {
		["Toggle"] = 'Off',
	...
	Normal = {
	  ["Toggle"] = 'Off',
	  ["Description"] = "Please, Don't Troll. By CuddlyZombie",
	  ["Counter"] = 0
	},
	Shakespeare = {
	  ["Toggle"] = 'Off',
	  ["Description"] = "Shakespeare. By Kerbtree",
	  ["Counter"] = 0
	},
    NBA_Jam = {
	  ["Toggle"] = 'Off',
	...
	Dictionary = {
		["Toggle"] = 'Off',
		["Description"] = "That's not how you spell 'oculus'. Made by Technogeek and Funso Banjo, with addition from Has no meaning",
		["Counter"] = 0
	},
	Terms_of_Use = {
		["Toggle"] = 'Off',
		["Description"] = "Made by Pope Guilty",
		["Counter"] = 0
	},
	Spoiler = {
		["Toggle"] = 'Off',
	...
	Barkley_Gaiden = {
		["Toggle"] = 'Off',
		["Description"] = "SHUT UP AND JAM. Made by Has no meaning with addtion from CuddlyZombie",
		["Counter"] = 0
	},
	m8 = {
		["Toggle"] = 'Off',
  		["Description"] = "A mix of bro and chief module. Idea from HUMAN FISH",
		["Counter"] = 0
	},
	Bosses = {
		["Toggle"] = 'Off',
  		["Description"] = "World of Warcraft Boss quotes. Made by Dexaan w/ addition from webmesiter and me, the sneep",
		["Counter"] = 0
	},
	Sportscaster = {
		["Toggle"] = 'Off',
  		["Description"] = "World of Warcraft Boss quotes. Made by Mr. Met w/ additions by Incoherence and Sneep",
		["Counter"] = 0
	},
	Neckbeard = {
	  ["Toggle"] = 'Off',
	  ["Description"] = "Big fat neckbeards getting offended by swears. Made by Windows 98",
	  ["Counter"] = 0
	},
	Rapture = {
	  ["Toggle"] = 'Off',
	  ["Description"] = "It's like bioshock right???. Made by Stubby",
	  ["Counter"] = 0
	},
	GamerCulture = {
	  ["Toggle"] = 'Off',
	  ["Description"] = "Social activism for misogynists. Made by Ocrumsprug",
	  ["Counter"] = 0
	},
};
...
addon.moduleText = {
	...
	Riko = {
		...
		"You nothing but blik-jeekin' dikkity dook-manker who swears in WoW! -Riko #stopcussing #YOLO",
